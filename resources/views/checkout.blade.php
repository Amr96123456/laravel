...
<section class="shop-checkout container">
    ...
    <div class="checkout-form">
        ...
        <div class="row">
            <div class="col_md_17">
                <div class="my_account__address_list">
                    <div class="my-account__address-list-item">
                        <divc class="my-account__address-list__detail">
                            <p>{{$address->name}}</p>
                            <p>{{$address->address}}</p>
      ...
      @endif
        ...
        <div class="sticky-content">
            ...
            <div class="form-check">
                <input class="form-check-input form-check-input_fill" type="radio" name="mode" card="Paypal"
                id="mode2">
