        ...
        <div class="col-lg-7">
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset("uploade/products")}}/{{$product->image}}"idth="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{asset("uploade/products")}}/{{$product->image}}" data-bs-toggle="tooltip"
                  ...
                  @foreach (explode(',',$products->images) as $gimg )


                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset("uploade/products")}}/{{$gimg }}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{asset("uploade/products")}}/{{$gimg }}" data-bs-toggle="tooltip"
                      data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"src="{{asset("uploade/products/thumbnails")}}/{{$product->image}}"width="104" height="104" alt="" /></div>
                                    @foreach (explode(',',$products->images) as $gimg )
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"src="{{asset("uploade/products/thumbnails")}}/{{$gimg}}" width="104" height="104" alt="" /></div>
                  @endforeach
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-5">
          ...
          <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
            ...
            <div class="product-single__addtocart">
              ...
              <input type="hidden" name="pricen" value="{{$product->sale_price == "" ? $product->regular_price : $product->sale_price}}">
              <button type="submit" class="btn btn-primary btn-addtocart " data-aside="cartDrawer">Add toCart</button>
            </div>
          </form>
          @endif
          <div class="product-single__addtolinks">
            ...
            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('frm-remove-item').submit();"><svg width="16" height="16" viewBox="0 0 20 20"
                ...
                <use href="#icon_heart" />
              </svg><span> Remove From to Wishlist</span></a>
            </form>
              @else
            ...
            <script src="{{asset("js/share.html0")}}" defer="defer"></script>
                   </div>
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.details',['product_slug'=>$rproduct->slug])}}">
                  <img loading="lazy" src="{{asset("uploade/products")}}\{{$product->image}}"width="330" height="400"alt="{{$product->name}}" class="pc__img">
                  @foreach (explode(",",$rproduct->images) as $gimg )
                  <img loading="lazy" src="{{asset("uploade/products")}}\{{$gimg}}" width="330" height="400" alt="{{$product->name}}" clask4s="pc__img pc__img-second">
                  @endforeach
                </a>
                ...
                <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                    ...
                    <input type="hidden" name="quantity" value="1">
                    <input type="hidden" name="name" value="{{$product->name}}">
                    <input type="hidden" name="pricen" value="{{$product->sale_price == "" ? $rproduct->regular_price : $rproduct->sale_price}}">
            </div>
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__price d-flex">
                  <span class="money price">
                    @if($prouct->sale_price)
                    <s>{{$product->regular_price}}/{{$rproduct->sale_price}}</s>
                    @else
                    ${{$product->regular_price}}
                    @endif
                  </span>
