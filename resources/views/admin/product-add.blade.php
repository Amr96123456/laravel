        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"action="{{route('admin.product.store')}}">
            ...
            <div class="wg-box">
                ...
                <div class="gap22 cols">
                    ...
                    <fieldset class="brand">
                        ...
                        <div class="select">
                            <select class="" name="brand_id">
                                ...
                                <option value="{{$brand->id}}">{{$category->name}}</option>
                                @endforeach
                    ...
                    @error('brand_id')<span class="alert alert-danger text-center">{{$message}}  @enderr
                </div>
                ...
                <fieldset class="shortdescription">
                    ...
                    <textarea class="mb-10 ht-150" name="short_description"placeholder="Short Description" tabindex="0" aria-required="true"
                        required="">{{old('short_descrription')}}</textarea>
                    <div class="text-tiny">Do not exceed 100 characters when entering the
                        product name.</div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview" style="display:none">
                            <img src="../../../localhost_8000/images/upload/upload-1.p"class="effect8" alt="">
                        </div>
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter SKU" name="SKU"
                            tabindex="0" value="" aria-required="true" required="{{old('SKU')}}">
                    </fieldset>
