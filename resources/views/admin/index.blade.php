                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardDatas[0]->TotaledDelivered}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{$dashboardDatas[0]->TotaledDeliveredAmount}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$order->orderItems}}</td>
                                    <td class="text-center">{{$order->delivered_date}}</td>
                                    <td class="text-center">
                                        <a href="{{route('admin.order.details',['order_id'=>$order_id])}}">
