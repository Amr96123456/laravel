        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.slide.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Title" name="Tagline"
                        tabindex="0" value="{{old('tagline')}}" aria-required="Tagline" required="">
                </fieldset>
                ...
                <fieldset class="category">
                    ...
                    <div class="select flex-grow">
                        <select name="status" class="">
                            ...
                            <option value="0"@if (old('status')=="1") selected @endif>in active</option>
                        </select>
                    </div>
                </fieldset>
