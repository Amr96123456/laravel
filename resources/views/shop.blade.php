...
<style>
  ...
  <main class="pt-90">
                    ...
                    <ul class="list list-inline mb-0 brand-list">
                        ...
                        <li class="list-item">
                            <span class="menu-link py-1">
                                ...
                                @if (in_array($brand->id , expldoe(',',$f_brands)))checked="checked" @endif>
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
              <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page size"id="pagesize" name="pagsize" style="margin-right:200px;"
            name="total-number">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset("upload/products")}}/{{$product->image}}" width="330"height="400" alt="{{$product->name}}" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                        @foreach (explode(",",$product->images) as $gimg )

                      <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset("upload/products")}}/{{$gimg}}"width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                      @endforeach
                    </div>
                  </div>
    ...
    <form id="frmfilter" method="GET" action="{{route('shop.index')}}">
        <input type="hidden" name="page" id="{{$products->currentpage()}}">
        <input type="hidden" name="size" id="{{$size}}"/>
        <input type="hidden"name="order" id="order" value="{{$order}}"/>
        <input type="hidden" name="brands"  id="hdnBranda"/>
    ...
    <script>
                $(function(){
                    ...
                    $("input[name='brands']:change").each(function(){
                        var brands ="";
                    ...
                    $("input[name='categories']:change").each(function(){
                        var brands ="";
