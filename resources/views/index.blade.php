        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{asset("upload/slides")}}/{{$slide->image}}"width="542" height="733"
                alt="Woman Fashion 1"
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">{{$skide->subtitle}}</h2>
              <a href="{{$slide->link}}"
        ...
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset("uploade/categories")}}/{{$category->image}}"width="124"
                  height="124" alt="" />
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{route('shop.prodect.details',['product_slug'=>$sproduct->slug])}}">
                        <img loading="lazy" src="{{asset('upload/products')}}/{{$sproduct->image}}" width="258" height="313"
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="{{route('shop.product.details',['product_slug'=>$fproduct->slug])}}">
                  <img loading="lazy" src="{{asset("upload/products")}}/{{$fproduct->image}}" width="330" height="400"
